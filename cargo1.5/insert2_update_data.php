...
$qr="update ship1 set name='$vname', mobile='$vmobile', email='$vemail', address='$vaddress', district='$vdistrict',state='$vstate', country='$vcountry', gst='$vgst',remark='$vremark' where sno='$vid'";
